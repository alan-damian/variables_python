...
nombre_completo_1 = str(input('ingrese nombre completo del padre'))
nombre_completo_2 = str(input('ingrese nombre completo de la madre'))
nombre = str(input('ingrese solo nombre del hijo'))
